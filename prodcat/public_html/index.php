...
require __DIR__ . '/../yii2_prodcat/frontend/config/bootstrap.php';

$config = yii\helpers\ArrayHelper::merge(
    require __DIR__ . '/../yii2_prodcat/common/config/main.php',
    require __DIR__ . '/../yii2_prodcat/common/config/main-local.php',
    require __DIR__ . '/../yii2_prodcat/frontend/config/main.php',
    require __DIR__ . '/../yii2_prodcat/frontend/config/main-local.php'
);
